...
// and try to use it.
public class Hive : BasicAICreature
{
	...
	void OnCollisionEnter2D(Collision2D collision)
	{
		...
		spriteRenderer.sprite = MimicStairs;
		...
		for (int i = 0; i < spawnCount; i++)
		{
			...
			//GameObject newBullet = Instantiate(bugs, randomPosition, Quaternion.identity);
